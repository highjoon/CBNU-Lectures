...
3. **Node.js, MySQL 활용하여 핵심 기능 추가**
    ...
    - **Routing 구축.**
        ...
        <br><br>
        <a href="#"><img src="./images/상품등록.png" width="900px" height="900px" alt="상품등록"></a>
        <br><br>
        ...
        <br><br>    
        <a href="#"><img src="./images/낮은금액입찰.png" width="900px" height="900px" alt="낮은금액입찰"></a>
        <br><br>
    ...
    <br><br>
    <a href="#"><img src="./images/실시간경매.jpg" width="900px" height="900px" alt="실시간경매"></a>
    <br>
# 3. 결과
전체 페이지 캡처입니다.
<br><br>
<a href="#"><img src="./images/전체1.png" width="900px" height="900px" alt="전체페이지1"></a><br><br>
<a href="#"><img src="./images/전체2.png" width="900px" height="900px" alt="전체페이지2"></a><br><br>
<a href="#"><img src="./images/전체3.png" width="900px" height="900px" alt="전체페이지3"></a><br><br>
<a href="#"><img src="./images/전체4.png" width="900px" height="900px" alt="전체페이지4"></a><br><br>
<a href="#"><img src="./images/전체5.png" width="900px" height="900px" alt="전체페이지5"></a><br><br>
